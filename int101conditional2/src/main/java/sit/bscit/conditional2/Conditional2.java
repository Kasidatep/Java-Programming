package sit.bscit.conditional2;

public class Conditional2 {
    public static void main(String[] args) {
        //testShortCircuitBooleanOperators();
        //testIfStatements(); // if, if-else, nested if-else
       //***************** testConditionalExpressions(); // ... ? ... : ...
        testSwitchStatements(); // switch (...) { case ... : ...; break; } // { case ... -> ...; }
        //testSwitchExpressions(); // switch (...) { case ... : ...; yield ...; }; // { case ... -> ...; };
    }
    
    public static void testShortCircuitBooleanOperators() {

        System.out.println("--------------------------------");
        System.out.println("Test of Short-Circuit and Non-Short-Circuit Boolean Operators");
        ...
        // -------------------------------------------------
        // non-short-circuit boolean operators: AND (&), OR (|)
    ...
    public static void testIfStatements() {
        ...
        System.out.println("--------------------------------");
        System.out.println("Test of IF Statements");
        ...
        int value2 = 3; // try this with different values, e.g., -2, -1, 0, 1, 2.
        if (value2 % 2 == 0)
    ...
    public static void testConditionalExpressions() {

        System.out.println("--------------------------------");
        System.out.println("Test of Conditional Expressions: ... ? ... : ...");
    ...
    public static void testSwitchStatements() {
        ...
        System.out.println("--------------------------------");
        System.out.println("Test of Switch Statements");
    ...
    public static void testSwitchExpressions() {

        System.out.println("--------------------------------");
        System.out.println("Test of Switch Expressions");
